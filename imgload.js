(function () {
  ...
  if (fallbackMode || waitingForController) {
    document.write('<style id="hces-fallback-wait" type="text/css">html,body{background:#ffffff!important;}body{visibility:hidden!important;}</style>');
  }
